...
#define OV2640_POWER_OFF  HAL_GPIO_WritePin(GPIOA, DCMI_PWDN_Pin, GPIO_PIN_SET)
#define OV2640_POWER_ON HAL_GPIO_WritePin(GPIOA, DCMI_PWDN_Pin, GPIO_PIN_RESET)

#define DCMI_RESET_Pin GPIO_PIN_4
#define OV2640_RESET_H  HAL_GPIO_WritePin(GPIOC, DCMI_RESET_Pin, GPIO_PIN_SET)
#define OV2640_RESET_L HAL_GPIO_WritePin(GPIOC, DCMI_RESET_Pin, GPIO_PIN_RESET)

#define DCMI_XCLK_Pin GPIO_PIN_8

#define DCMI_LED_Pin GPIO_PIN_8
#define OV2640_LED_ON  HAL_GPIO_WritePin(GPIOB, DCMI_LED_Pin, GPIO_PIN_SET)
#define OV2640_LED_OFF HAL_GPIO_WritePin(GPIOB, DCMI_LED_Pin, GPIO_PIN_RESET)
...
//SXGA(1600*1200) 
static const uint8_t ov2640_sxga_init_reg_tbl[][2]= 
{
 	0xff, 0x01,
	0x12, 0x80,
